...
{
	static void PED_DEATH_DROP(float x, float y, float z, int amount, Hash bags) { STREAMING::REQUEST_MODEL(bags); invoke<Void>(14311548939713375618, x, y, z, amount, 1, bags); }
